window.onload = function() {
    ...
    var C_4205407 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    C_4205407.textContent = "⬤ Florianópolis";
    C_4205407.setAttribute("x", "278");
    C_4205407.setAttribute("y", "390");
    var E_42 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    E_42.textContent = "SC";
    E_42.setAttribute("x", "265");
    E_42.setAttribute("y", "390");

    var PUF_43 = document.createElementNS("http://www.w3.org/2000/svg", "path");
    PUF_43.setAttribute("d","M191.236,416.881c0.52-2.684,7.38-8.409,9.477-10.351c0.37-0.359,8.599-10.08,9.174-8.329c-1.301-3.89,2.781-1.589,3.917-4.819c0.26-0.521,7.04-4.821,7.109-4.795c1.436-0.191,6.721-3.695,7.421-3.257c1.204-2.028,8.927-1.479,8.653-0.824c1.165-0.38,2.284-0.877,3.326-1.479c0.221-0.821,22.459,7.533,24.319,11.531c2.523,5.34,12.217,2.822,13.15,5.563c0.106,0.275-5.809,9.339-3.89,9.173c-0.985,0.08,3.204-2.875,3.834,0.409c-2.793,3.619-4.6,7.834-6.571,11.944c-3.696,7.614-8.872,12.765-15.886,17.42c-7.394,4.902-7.339,11.941-13.257,17.693c-8.091,7.942-10.159-0.574-4.08-5.752c3.806-3.231-22.527-19.746-25.578-22.732c-1.918-1.862-2.384,0.274-4.219,1.15c-2.547,1.205-1.917-2.822-3.588-4.273c-2.3-1.999-4.793-5.479-7.737-6.68c-3.478-1.367-5.615,5.145-9.052,0.821C189.168,418.854,190.332,418.032,191.236,416.881z");
    var C_4314902 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    C_4314902.textContent = "⬤ Porto Alegre";
    C_4314902.setAttribute("x", "265");
    C_4314902.setAttribute("y", "416");
    var E_43 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    E_43.textContent = "RS";
    E_43.setAttribute("x", "228");
    E_43.setAttribute("y", "418");

    var PUF_35 = document.createElementNS("http://www.w3.org/2000/svg", "path");
    PUF_35.setAttribute("d","M239.3,330.554c3.26-4.356,9.56-5.039,11.531-10.792c1.369-3.942,3.889-8.818,6.135-13.036c1.561-2.957,7.749-7.121,10.517-8.65c0.383-0.196,32.974-6.138,42.234-1.701c20.265,9.724,26.017,33.879,27.854,33.304c4.408-1.425,5.34,3.778,2.106,4.49c-1.754,0.413-6.519,1.479-6.49,3.399c0.027,3.448,0.521,1.615-2.931,3.639c-2.189-1.42-3.34,4.111-4.763,3.426c-4.271-2.244-6.958,2.96-9.258,1.918c-4.271-1.918-16.98,13.092-19.638,15.336c0.245-0.218-1.148-1.479-1.587-2.685c-0.466-1.369-2.658,0.385-4.025,0.082c-0.986-0.192,1.751-4.079-2.303-4.52c-1.369-0.164-3.753,0.303-4.929,0.084c-2.903-0.547,0.108-2.41-0.439-3.862c-1.067-2.986-3.013-4.931-3.751-7.779c-0.52-1.945,0.165-7.531-3.615-7.395c-0.848-2.956-6.628-1.451-9.066-1.862c-0.162,0.163-8.846-2.684-10.079-2.684c-1.616-0.029-6.791-3.396-7.121-0.274C247.982,330.386,239.876,331.21,239.3,330.554z");
    var C_3550308 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    C_3550308.textContent = "⬤ São Paulo";
    C_3550308.setAttribute("x", "295");
    C_3550308.setAttribute("y", "350");
    var E_35 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    E_35.textContent = "SP";
    E_35.setAttribute("x", "278");
    E_35.setAttribute("y", "327");

    var PUF_31 = document.createElementNS("http://www.w3.org/2000/svg", "path");
    PUF_31.setAttribute("d","M262.881,297.305c-1.696-5.094,15.531-19.882,18.844-13.421c5.531-7.367,15.886,1.588,19.773-3.944c0.988-1.367,3.015-1.453,3.725-2.957c0.326-0.711-0.493-2.793-0.056-3.888c1.369-3.398-4.873-2.355-0.109-6.603c4.547-4.053-1.917-4.739-1.204-8.186c0.957-4.604,1.807-4.713,5.613-6.027c1.943-0.688,0.906-8.272,0.083-8.52c-0.108-2.699,1.974-2.546,3.782-1.617c2.188-0.135-0.276-3.695,0.957-4.243c-0.357,0.151,5.559,1.999,5.724,2.055c0.986,0.358-0.52,3.534-0.931,3.943c8.217-2.355,14.514-11.789,23.279-11.242c4.983,0.316-0.327,4.339,5.367,5.544c0.684,1.234,3.34-1.054,4.054-1.189c2.876-0.536,5.53,3.284,8.106,3.886c2.301,3.578,7.503,0.537,10.298,3.001c1.755,1.589,2.188,3.397,3.396,5.313c1.314,2.052,3.86-0.465,5.726-0.109c3.257,0.656,6.326,2.026,9.338,3.723c2.19,1.205,0.768,3.179-0.548,4.573c-0.765,0.796-3.259,6.165-2.627,5.643c-2.138,1.781-2.628-1.669-3.397,2.764c-0.628,3.674,0.164,4.714,3.149,7.015c4.901,3.229-6.765,3.12-6.71,3.504c0.22,0.601-2.846,41.96-3.835,42.179c-6.737,1.562-14.513,5.311-21.744,7.012c-12.736,2.985-24.295,3.778-29.471,4.656c0,1.452-5.367,6.872-8.518,1.259c0,0-3.041-7.285-2.821-7.229c0.105-0.027,2.138-5.506,2.244-6.137c0.768-3.504-5.042-0.765-5.749-2.188c-0.878-1.81-2.358-4.576-2.166-6.628c1.699-1.205,1.672-2.383-0.08-3.562c-1.04-1.095-1.205-2.303-0.521-3.672c-2.329-1.424-3.065-2.683-5.698-2.462c-1.479,0.138-4.055,3.668-5.506,0.629c0.878,2.108-4.188,0.769-5.094,1.56c-2.354-1.202-1.779,2.028-2.384,3.069c-0.137,0.22-1.014-2.904-1.065-2.961c-1.149-1.175-2.767,4.165-3.505-0.055c0.766-4.105-4.657-2.709-7.67-2.93c-4.708-0.353-5.53-1.613-9.858,0.631C262.993,300.562,262.336,299.274,262.881,297.305z");
    var C_3106200 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    C_3106200.textContent = "⬤ Belo Horizonte";
    C_3106200.setAttribute("x", "332");
    C_3106200.setAttribute("y", "314");
    var E_31 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    E_31.textContent = "MG";
    E_31.setAttribute("x", "328");
    E_31.setAttribute("y", "285");

    var PUF_33 = document.createElementNS("http://www.w3.org/2000/svg", "path");
    var CUF_33 = document.createElementNS("http://www.w3.org/2000/svg", "path");
    PUF_33.setAttribute("d","M332.886,337.429c-1.26-2.768,8.409-4.795,7.89-6.71c-3.177-1.864-4.602,1.148-6.63-2.959c4.274-0.686,9.533-4.49,13.831-3.562c0.548-0.219,4.902-1.753,4.96,0.167c2.546-1.566,5.479-2.412,8.105-3.837c2.246-1.206,0.932-8.218,3.725-9.643c6.054-3.123,1.398,1.836,7.066,2.959c5.888,1.205,5.395,1.48,5.641,7.067c0.247,5.642-8.763,4.381-11.063,8.764c-1.039,1.999,1.698,5.368-3.368,4.903c-4.188-0.413-10.628,2.355-9.285-3.18c-1.039-0.08-1.861,0.301-2.464,1.124c0,0,0.105,2.767-0.74,2.741c-0.766-0.056-7.643,1.094-7.449,0.463c1.398-0.359,2.708-0.684,4.135-0.794c-1.667-0.713-2.957-1.839-4.901-0.142c0.465,0.195-4.227-0.086-3.379-0.113c-0.521,1.727-3.814,0.699-3.879,3.045C336.717,337.908,333.927,342.41,332.886,337.429z");
    var C_3304557 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    C_3304557.textContent = "⬤ Rio de Janeiro";
    C_3304557.setAttribute("x", "352");
    C_3304557.setAttribute("y", "335");
    CUF_33.setAttribute("d","M355.094,318.613c6.209,0,11.263,5.021,11.263,11.259c0,6.208-5.056,11.264-11.263,11.264c-6.211,0-11.263-5.054-11.263-11.264C343.831,323.634,348.883,318.613,355.094,318.613z");
    var E_33 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    E_33.textContent = "RJ";
    E_33.setAttribute("x", "346");
    E_33.setAttribute("y", "335");

    var PUF_32 = document.createElementNS("http://www.w3.org/2000/svg", "path");
    var CUF_32 = document.createElementNS("http://www.w3.org/2000/svg", "path");
    PUF_32.setAttribute("d","M367.119,308.834c1.044-1.999-0.298-5.451,1.841-6.326c3.697-1.453,3.858-0.467,5.941-4.49c0.767-1.563,3.999-5.807,2.848-7.835c-0.439-0.765-3.204-3.613-3.286-4.05c1.04-0.249,2.079-0.219,3.123,0.054c1.366-0.654-6.465-10.519,2.137-8.054c-1.204-0.655-1.535-1.365-0.932-2.135c4.358-0.138,13.856,0.027,12.845,6.738c-0.577,3.835,0.933,8.079-0.577,11.804c-0.218,0.576-5.861,8.954-5.831,8.954c0.985,3.289-5.18,5.808-6.054,8.165c-1.313,3.56-2.135,3.013-5.614,2.573c-1.64-0.274-3.202-0.768-4.736-1.451C368.819,311.297,369.424,309.055,367.119,308.834z");
    var C_3205309 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    C_3205309.textContent = "⬤ Vitória";
    C_3205309.setAttribute("x", "378");
    C_3205309.setAttribute("y", "302");
    CUF_32.setAttribute("d","M381.917,284.723c6.21,0,11.261,5.055,11.261,11.262c0,6.212-5.051,11.261-11.261,11.261c-6.212,0-11.263-5.049-11.263-11.261C370.654,289.777,375.705,284.723,381.917,284.723z");
    var E_32 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    E_32.textContent = "ES";
    E_32.setAttribute("x", "372.5");
    E_32.setAttribute("y", "301");

    var PUF_25 = document.createElementNS("http://www.w3.org/2000/svg", "path");
    var CUF_25 = document.createElementNS("http://www.w3.org/2000/svg", "path");
    PUF_25.setAttribute("d","M401.575,141.096c2.081-3.081,16.791-6.82,19.117-4.616c0,1.918,7.259,1.686,10.133,2.712c-0.492,3.038,12.652,1.533,14.408,2.259c1.421,0.589,3.833,11.983,1.421,12.202c-0.874-1.124-2.083-1.739-3.586-1.835c-2.957-0.027-2.546,1.863-4.383,3.108c-2.626,1.767-6.571,1.917-9.558,2.109c-0.162,1.232-3.943,4.438-5.259,4.916c-3.122,1.149-2.657-2.727-5.095-3.602c0.713-1.124,4.082-5.203,3.725-6.205c-1.423-3.846-12.051,5.52-14.981,3.506c-1.396-0.973-6.218,1.493-3.476-2.588C405.574,150.776,400.398,142.889,401.575,141.096z");
    var C_2507507 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    C_2507507.textContent = "⬤ João Pessoa";
    C_2507507.setAttribute("x", "434");
    C_2507507.setAttribute("y", "152");
    CUF_25.setAttribute("d","M433.797,133.597c6.237,0,11.26,5.051,11.26,11.261c0,6.226-5.022,11.262-11.26,11.262c-6.208,0-11.257-5.036-11.257-11.262C422.54,138.647,427.589,133.597,433.797,133.597z");
    var E_25 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    E_25.textContent = "PB";
    E_25.setAttribute("x", "424");
    E_25.setAttribute("y", "150");

    var PUF_53 = document.createElementNS("http://www.w3.org/2000/svg", "path");
    var CUF_53 = document.createElementNS("http://www.w3.org/2000/svg", "path");
    PUF_53.setAttribute("d","M292.461,246.197c0,0,12.929-2.903,14.188,0c1.233,2.903,0.659,10.683-1.424,11.504c-2.08,0.849-14.296-1.806-14.023-3.313C291.503,252.853,292.461,246.197,292.461,246.197z");

    CUF_53.setAttribute("d","M300.735,238.34c6.212,0,11.26,5.035,11.26,11.258c0,6.21-5.048,11.263-11.26,11.263c-6.209,0-11.261-5.053-11.261-11.263C289.475,243.377,294.523,238.34,300.735,238.34z");
    var E_53 = document.createElementNS("http://www.w3.org/2000/svg", "text");
    E_53.textContent = "DF";
    E_53.setAttribute("x", "291");
    E_53.setAttribute("y", "255");
...
criarMapas(estados.join(','),0);criarMapas(capitais.join(','),1); 

function criarMapas(ids, Mapa) {var PathArea = '';var idNomes = ids.split(',');var idPaths = ids.split(',');var tipoMapa = '';var tipoTexto = '';for (var i = 0; i < idNomes.length; i++) {tipoTexto = (idNomes[i].length > 2 ? 'C_' : 'E_');tipoMapa = (idNomes[i].length > 2 ? 'BUF' : 'AUF');if (tipoTexto == 'C_') {idPaths = capitais.map(function(idNomes) {return idNomes.substring(0, 2);});};svg[Mapa].append(eval(tipoTexto + idNomes[i]));PathArea += tipoMapa + '[' + i + '].append(PUF_' + idPaths[i] + '.cloneNode(true)' + ');'};eval(PathArea);}}
